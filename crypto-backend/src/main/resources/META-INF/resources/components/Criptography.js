...
class Criptography extends HTMLElement {
    onError = false;
    errorMessage = "";
    ...
    connectedCallback() {
        ...
        const template = html`
            ...
            <label for="pet-select">Seleziona un algoritmo: </label>
    ...
    async handleSubmit() {
        ...
        document.getElementById("hashedText").value = body.outputText;
        document.getElementById("hashedText").disabled = false;
    }
}

customElements.define('c-criptography', Criptography);